...
export default function Index({ sidebarOpen, setSidebarOpen }) {
  return (
    <header className="sticky top-0 z-[999] w-full bg-white drop-shadow-sm">
      <div className="flex flex-grow items-center justify-between lg:justify-end px-4 py-4 shadow md:px-6 2xl:px-11">
